...
<html lang="en">
  <head>
    ...
    <title>Cake shoop Ichaa</title>
  </head>
  <body>
    <nav class="navbar navbar-light bg-light">
      <div class="container">
        <a class="navbar-brand" href="index.php"> Welcome Cake shoop icha ˶ᵔ ᵕ ᵔ˶</a>
                  ...
                  <div class="col-12">
                    <div class="row">
                      <div class="col-12 col-lg-6">
                        <h5>MyCake Shoop</h5>
                        <p class="mt-3">Kuenya yang sangat enak<br>dan teskturnya lembut, rasa manis pas sekali!!<br>Harga terjangkau hemat dikantong ପ(๑•ᴗ•๑)ଓ</p>
        ...
        <div class="container-fluid">
          <div class="row border-top justify-content-center align-items-center pt-4 ">
            <div class="col-auto text-gray-500 font-weight-light">
                2023 MyCake Shoop • All rights reserved 
            </div>
          </div>
        </div>
    </footer>
